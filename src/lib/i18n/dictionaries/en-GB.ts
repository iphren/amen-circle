...
export const enGB = {
  ...
  landing: {
    ...
    prayerRules: [
      ...
      "Write what you'd like someone to pray for.",
      "Each request is given to another to pray for.",
      "Don't tell others who you're praying for.",
      "You won't know who is praying for you.",
      "Share your testimony when you are ready.",
