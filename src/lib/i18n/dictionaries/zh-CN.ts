      ...
      sections: [
        ...
        },
        {
          ...
          blocks: [
            {
              type: "p",
              md: "我们使用以下处理方：Neon（数据库托管）以及 Amazon Web Services — Amplify 用于托管，SES 用于事务邮件，CloudWatch 用于日志 — 均在 eu-west-2（伦敦）区域。我们不会向任何其他人出售或分享你的数据，本网站没有广告或分析追踪。",
            },
          ],
        },
        {
        ...
        },
        {
          ...
          blocks: [
            {
              type: "p",
              md: "所有代祷事项内容都会在静态存储时加密（AES-256-GCM），并叠加数据库服务商提供的磁盘级加密。登录使用通行密钥，因此我们从不存储密码。登录和账号找回链接都是一次性、短时有效，并且只以哈希形式保存。",
            },
          ],
        },
        {
