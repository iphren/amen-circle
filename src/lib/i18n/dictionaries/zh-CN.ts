...
export const zhCN: DeepPartial<Dictionary> = {
  ...
  auth: {
    ...
    haveAccount: "已有账号？登录",
    newHere: "第一次来？注册",
    troublePasskey: "发送邮箱登录链接",
    lostDevice: "设备丢失了？",
    emailSignupLink: "改为给我发送注册链接",
    sendingSignupLink: "正在发送…",
    signupLinkSentNote:
      "我们已向 {email} 发送了一个链接，请在 15 分钟内打开以完成注册。如果你已有账号，该链接会直接为你登录。",
    errors: {
      couldNotStartRegistration: "无法开始注册",
      couldNotSendSignupLink: "无法发送注册链接",
  ...
  emails: {
    ...
    registrationLink: {
      subject: "完成你的同心圆账号注册",
      previewLabel: "注册链接",
      bodyIntro: "你请求使用邮箱链接创建 {appName} 账号。",
      ctaLabel: "激活我的账号",
      expiryNote: "此链接将在 15 分钟后过期，且只能使用一次。",
    },
  },
      ...
      sections: [
        ...
        },
        {
          ...
          blocks: [
            {
              type: "p",
              md: "所有代祷事项内容都会在静态存储时加密（AES-256-GCM），并叠加服务器的磁盘级加密。登录使用通行密钥，因此我们从不存储密码。登录和账号找回链接都是一次性、短时有效，并且只以哈希形式保存。",
            },
          ],
        },
        {
          ...
          blocks: [
            {
              ...
              items: [
                ...
                "过期的登录和账号找回链接会自动清除。",
                "服务器访问日志保留 30 天。",
                "加密的数据库备份最多保留 30 天。你删除的数据会立即从线上数据库中移除，并在该期限内从备份中自然过期。",
              ],
            },
          ],
        },
